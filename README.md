...
# 📖 [Mountains] <a name="about-project"></a>

**[Mountains]** is a project which was built as a Single Page App which was created to show captivatiing UI.
...
- [Live Demo Link](https://uthmanbello.github.io/mountains/)
...
`git clone https://github.com/Uthmanbello/mountains`<br>
`cd mountains`<br>
...
Feel free to check the [issues page](https://github.com/Uthmanbello/mountains/issues/).
...
I would like to thank my Coalition technologies for giving me the opportunity to take part in the development test.

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 📝 License <a name="license"></a>

This project is [MIT](https://github.com/Uthmanbello/mountains/blob/dev/LICENSE) licensed.
